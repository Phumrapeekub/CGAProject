...
class HmmPredictor:
    def __init__(self):
        ...
        self.model = None
        self.scaler = None
        # Lazy loading when first needed or explicitly called
        # Not loading in init to avoid startup crash
    ...
    def _load_model(self):
        ...
        try:
            ...
            if os.path.exists(self.model_path) and os.path.exists(self.scaler_path):
                ...
                print(f"❌ HMM Model or Scaler file not found at {self.model_path}")
                return False
