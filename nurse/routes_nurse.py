...
from ml.hmm_predictor import predictor # ðŸŸ¢ Import AI Predictor
...
def inject_user():
    ...
    return dict(user=session.get('full_name') or session.get('username') or 'à¸žà¸¢à¸²à¸šà¸²à¸¥')
...
def address_search():
    ...
    try:
        ...
        # à¹ƒà¸Šà¹‰à¸Šà¸·à¹ˆà¸­à¸„à¸­à¸¥à¸±à¸¡à¸™à¹Œà¸ˆà¸£à¸´à¸‡à¸•à¸²à¸¡à¸—à¸µà¹ˆà¸„à¸¸à¸“à¹à¸ˆà¹‰à¸‡à¸¡à¸²
...
def _require_nurse():
    ...
    if not user_id:
        ...
        flash("à¸à¸£à¸¸à¸“à¸²à¹€à¸‚à¹‰à¸²à¸ªà¸¹à¹ˆà¸£à¸°à¸šà¸šà¸à¹ˆà¸­à¸™", "warning")
...
def safe_supabase_sync(table, data, method='upsert', conflict_col='hn') -> Tuple[bool, str]:
    ...
    à¸£à¸°à¸šà¸šà¸ªà¹ˆà¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸‚à¸¶à¹‰à¸™ Supabase à¹à¸šà¸šà¸­à¸±à¸ˆà¸‰à¸£à¸´à¸¢à¸° 

    à¸«à¸²à¸à¸„à¸­à¸¥à¸±à¸¡à¸™à¹Œà¹„à¸«à¸™à¹„à¸¡à¹ˆà¸¡à¸µà¹ƒà¸™ Cloud à¸ˆà¸°à¸—à¸³à¸à¸²à¸£à¸‚à¹‰à¸²à¸¡à¹à¸¥à¸°à¸žà¸¢à¸²à¸¢à¸²à¸¡à¸ªà¹ˆà¸‡à¹ƒà¸«à¸¡à¹ˆà¸ˆà¸™à¸ªà¸³à¹€à¸£à¹‡à¸ˆ

    à¸„à¸·à¸™à¸„à¹ˆà¸² (is_success, message)

    """

    # ðŸ› DEBUG HOOK: Log payload before sending
    ...
    try:
        ...
        return False, f"à¹€à¸Šà¸·à¹ˆà¸­à¸¡à¸•à¹ˆà¸­ Cloud à¹„à¸¡à¹ˆà¹„à¸”à¹‰: {e}"
    ...
    for i in range(10):
        ...
        try:
            ...
            # à¸–à¹‰à¸² Error à¹€à¸žà¸£à¸²à¸°à¹„à¸¡à¹ˆà¸¡à¸µ Column à¹ƒà¸™ Cloud à¹ƒà¸«à¹‰à¸¥à¸­à¸‡à¸¥à¸š Column à¸™à¸±à¹‰à¸™à¸­à¸­à¸à¹à¸¥à¹‰à¸§à¸ªà¹ˆà¸‡à¹ƒà¸«à¸¡à¹ˆ
    ...
    return False, f"à¸žà¸¢à¸²à¸¢à¸²à¸¡à¸ªà¹ˆà¸‡à¸«à¸¥à¸²à¸¢à¸„à¸£à¸±à¹‰à¸‡à¹à¸¥à¹‰à¸§à¹„à¸¡à¹ˆà¸ªà¸³à¹€à¸£à¹‡à¸ˆ: {last_error}"
...
def _get_assess_data(conn, header_id):
    ...
    try:
        ...
        # à¸¥à¸­à¸‡à¸«à¸²à¸ˆà¸²à¸ cga_id à¸à¹ˆà¸­à¸™
        ...
        # à¸–à¹‰à¸²à¹„à¸¡à¹ˆà¹€à¸ˆà¸­ à¸¥à¸­à¸‡à¸«à¸²à¹‚à¸”à¸¢à¸¡à¸­à¸‡à¸§à¹ˆà¸² header_id à¸„à¸·à¸­ encounter_id (à¸à¸£à¸“à¸µà¸¡à¸²à¸ˆà¸²à¸à¸«à¸™à¹‰à¸²à¸›à¸£à¸°à¸§à¸±à¸•à¸´)
        ...
        if hn_val and str(hn_val).startswith("TMP"):
            ...
            try:
                ...
                # à¸–à¹‰à¸²à¹€à¸›à¹‡à¸™à¸„à¸™à¹„à¸‚à¹‰à¹ƒà¸«à¸¡à¹ˆà¸—à¸µà¹ˆà¸¢à¸±à¸‡à¸à¸£à¸­à¸à¹„à¸¡à¹ˆà¹€à¸ªà¸£à¹‡à¸ˆ à¹ƒà¸«à¹‰à¸¥à¸­à¸‡à¸«à¸² GCN à¹€à¸”à¸´à¸¡à¸—à¸µà¹ˆà¹€à¸„à¸¢à¸„à¸³à¸™à¸§à¸“à¹„à¸§à¹‰à¸à¹ˆà¸­à¸™
                ...
                if existing_gcn and existing_gcn['gcn']:
                    ...
                    # à¸–à¹‰à¸²à¹„à¸¡à¹ˆà¸¡à¸µà¸ˆà¸£à¸´à¸‡à¹† à¸„à¹ˆà¸­à¸¢à¸„à¸³à¸™à¸§à¸“à¹ƒà¸«à¸¡à¹ˆ (à¹€à¸‰à¸žà¸²à¸°à¹€à¸„à¸ªà¹ƒà¸«à¸¡à¹ˆà¹à¸à¸°à¸à¸¥à¹ˆà¸­à¸‡)
...
def dashboard():
    ...
    try:
        ...
        # ðŸŸ¢ à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¸¡à¸²à¹ƒà¸Šà¹‰ cga_records à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰à¸•à¸±à¸§à¹€à¸¥à¸‚à¸•à¸£à¸‡à¸à¸±à¸šà¸«à¸™à¹‰à¸²à¸£à¸²à¸¢à¸‡à¸²à¸™
        ...
        cur.execute("SELECT COUNT(*) AS c FROM cga_records cr JOIN cga_headers ch ON cr.encounter_id = ch.encounter_id WHERE ch.status != 'in_progress' cr JOIN cga_headers ch ON cr.encounter_id = ch.encounter_id WHERE ch.status != 'in_progress'")

        kpis["total"] = cur.fetchone()["c"]



        # ðŸŸ¢ à¸”à¸¶à¸‡à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¸¥à¹ˆà¸²à¸ªà¸¸à¸” 5 à¸£à¸²à¸¢à¸à¸²à¸£à¸ˆà¸²à¸ cga_records à¹‚à¸”à¸¢à¸•à¸£à¸‡
        ...
        cur.execute("""
            ...
            SELECT 
                ...
                CASE 
                    ...
                    WHEN (mmse_score <= 15 OR tgds_score >= 10 OR suicide_risk = 'à¸¡à¸µ') THEN 'high'
        ...
        # à¸ˆà¸±à¸”à¸£à¸¹à¸›à¹à¸šà¸šà¸§à¸±à¸™à¸—à¸µà¹ˆà¹ƒà¸«à¹‰ Template à¹ƒà¸Šà¹‰à¸‡à¸²à¸™à¹„à¸”à¹‰
    ...
    return render_template("nurse/dashboard.html", kpis=kpis, recent_patients=recent_patients, role="à¸žà¸¢à¸²à¸šà¸²à¸¥")
...
def api_kpis():
    ...
    try:
        ...
        # ðŸŸ¢ à¸­à¸±à¸›à¹€à¸”à¸•à¹ƒà¸«à¹‰à¸”à¸¶à¸‡à¸ˆà¸²à¸ cga_records
...
def reports():
    ...
    try:
        ...
        # ðŸŸ¢ 1. à¸ªà¸–à¸´à¸•à¸´à¸£à¸§à¸¡à¸ˆà¸²à¸ cga_records
        ...
        # ðŸŸ¢ 2. à¸£à¸²à¸¢à¸Šà¸·à¹ˆà¸­à¸à¸¥à¸¸à¹ˆà¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡à¹€à¸£à¹ˆà¸‡à¸”à¹ˆà¸§à¸™à¸ˆà¸²à¸ cga_records

        cur.execute("""

            SELECT encounter_id as header_id, hn, full_name, birth_date, mmse_score as mmse, tgds_score as tgds, 

                   CASE WHEN suicide_risk = 'à¸¡à¸µ' THEN 'yes' ELSE 'no' END as suicide

            FROM cga_records

            WHERE assessed_date BETWEEN %s AND %s

              AND (mmse_score <= 23 OR tgds_score >= 7 OR suicide_risk = 'à¸¡à¸µ')
        ...
        # ðŸŸ¢ à¹€à¸žà¸´à¹ˆà¸¡à¸à¸²à¸£à¸™à¸±à¸šà¸ªà¸–à¸´à¸•à¸´à¹‚à¸£à¸„à¸›à¸£à¸°à¸ˆà¸³à¸•à¸±à¸§ (Diseases)
        ...
        # ðŸŸ¢ à¹€à¸žà¸´à¹ˆà¸¡à¸à¸²à¸£à¸„à¸³à¸™à¸§à¸“ BMI Stats
...
def assess_create():
    ...
    try:
        ...
        cur.execute("INSERT INTO patients (hn, gcn, full_name) VALUES (%s, NULL, 'à¸£à¸­à¸à¸£à¸­à¸à¸‚à¹‰à¸­à¸¡à¸¹à¸¥')", (temp_hn,))
        ...
        # ðŸŸ¢ Sync à¸¥à¸‡ cga_records à¸—à¸±à¸™à¸—à¸µà¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰à¸£à¸²à¸¢à¸Šà¸·à¹ˆà¸­à¸›à¸£à¸²à¸à¸à¹ƒà¸™à¸«à¸™à¹‰à¸² Dashboard/Report
...
def assess_new_encounter(hn: str):
    ...
    try:
        ...
        if not patient:
            ...
            flash(f"à¹„à¸¡à¹ˆà¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢ HN: {hn}", "danger")

            return redirect(url_for('nurse.patients'))

            

        # 2. à¸ªà¸£à¹‰à¸²à¸‡ Encounter à¹ƒà¸«à¸¡à¹ˆ (à¸§à¸±à¸™à¸—à¸µà¹ˆà¸›à¸±à¸ˆà¸ˆà¸¸à¸šà¸±à¸™)

        # à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸à¹ˆà¸­à¸™à¸§à¹ˆà¸²à¸§à¸±à¸™à¸™à¸µà¹‰à¸¡à¸µ Encounter à¹à¸¥à¹‰à¸§à¸«à¸£à¸·à¸­à¸¢à¸±à¸‡ (à¸à¸±à¸™à¹€à¸šà¸´à¹‰à¸¥)
        ...
        if existing_enc:
            ...
            # à¹€à¸Šà¹‡à¸„à¸§à¹ˆà¸²à¸¡à¸µ Header à¸«à¸£à¸·à¸­à¸¢à¸±à¸‡
            ...
            if existing_header:
                ...
                flash(f"à¸¡à¸µà¹ƒà¸šà¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸‚à¸­à¸‡à¸§à¸±à¸™à¸™à¸µà¹‰à¸­à¸¢à¸¹à¹ˆà¹à¸¥à¹‰à¸§ ({patient['full_name']})", "warning")
        ...
        # 3. à¸ªà¸£à¹‰à¸²à¸‡ CGA Header à¹ƒà¸«à¸¡à¹ˆ (à¸–à¹‰à¸²à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µ)
        ...
        # 4. à¸ªà¸£à¹‰à¸²à¸‡ Session à¹ƒà¸«à¸¡à¹ˆ (à¸ˆà¸³à¹€à¸›à¹‡à¸™à¸ªà¸³à¸«à¸£à¸±à¸šà¸à¸²à¸£à¹€à¸à¹‡à¸š Answers)
        ...
        # 5. [Auto-fill] à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸žà¸·à¹‰à¸™à¸à¸²à¸™à¸ˆà¸²à¸à¹ƒà¸šà¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸¥à¹ˆà¸²à¸ªà¸¸à¸”à¸¡à¸²à¹ƒà¸ªà¹ˆà¹ƒà¸«à¹‰ (Clone Basic Info)

        # à¸«à¸² session_id à¸¥à¹ˆà¸²à¸ªà¸¸à¸”à¸à¹ˆà¸­à¸™à¸«à¸™à¹‰à¸²à¸™à¸µà¹‰à¸‚à¸­à¸‡à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¸„à¸™à¸™à¸µà¹‰
        ...
        if last_session:
            ...
            # à¸£à¸²à¸¢à¸à¸²à¸£ Field à¸—à¸µà¹ˆà¸•à¹‰à¸­à¸‡à¸à¸²à¸£ Clone (à¸—à¸µà¹ˆà¸­à¸¢à¸¹à¹ˆ, à¸œà¸¹à¹‰à¸”à¸¹à¹à¸¥, à¸ªà¸–à¸²à¸™à¸°, à¸à¸²à¸£à¸¨à¸¶à¸à¸©à¸², à¹‚à¸£à¸„à¸›à¸£à¸°à¸ˆà¸³à¸•à¸±à¸§)

            clone_fields = [

                'caregiver_name', 'caregiver_relation', 'emergency_phone', # à¸œà¸¹à¹‰à¸”à¸¹à¹à¸¥

                'house_no', 'moo', 'subdistrict', 'district', 'province', 'postal_code', # à¸—à¸µà¹ˆà¸­à¸¢à¸¹à¹ˆ

                'marry', 'live', 'education', # à¸ªà¸–à¸²à¸™à¸°à¸—à¸²à¸‡à¸ªà¸±à¸‡à¸„à¸¡

                'chronicDiseases' # à¹‚à¸£à¸„à¸›à¸£à¸°à¸ˆà¸³à¸•à¸±à¸§
            ...
            # à¸§à¸™à¸¥à¸¹à¸› Insert à¸¥à¸‡ Session à¹ƒà¸«à¸¡à¹ˆ

            for ans in old_answers:

                txt = ans['answer_text']

                # à¹€à¸Šà¹‡à¸„à¸§à¹ˆà¸²à¹€à¸›à¹‡à¸™ Field à¸—à¸µà¹ˆà¹€à¸£à¸²à¸­à¸¢à¸²à¸à¹„à¸”à¹‰à¹„à¸«à¸¡ (Format: key:value)

                if ':' in txt:

                    key = txt.split(':', 1)[0]

                    if key in clone_fields or key == 'chronicDiseases': # chronicDiseases à¸­à¸²à¸ˆà¸¡à¸²à¹ƒà¸™à¸£à¸¹à¸›à¹à¸šà¸š key:value à¸«à¸£à¸·à¸­ csv
        ...
        # ðŸŸ¢ Sync à¸¥à¸‡ cga_records à¸—à¸±à¸™à¸—à¸µ

        _sync_to_cga_records(header_id, conn, cur)

        

        flash(f"à¹€à¸£à¸´à¹ˆà¸¡à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¹ƒà¸«à¸¡à¹ˆà¸ªà¸³à¸«à¸£à¸±à¸šà¸„à¸¸à¸“ {patient['full_name']} à¹€à¸£à¸µà¸¢à¸šà¸£à¹‰à¸­à¸¢à¹à¸¥à¹‰à¸§ (à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹€à¸”à¸´à¸¡à¸¡à¸²à¹ƒà¸«à¹‰à¸šà¸²à¸‡à¸ªà¹ˆà¸§à¸™)", "success")
        ...
        flash(f"à¹€à¸à¸´à¸”à¸‚à¹‰à¸­à¸œà¸´à¸”à¸žà¸¥à¸²à¸”à¹ƒà¸™à¸à¸²à¸£à¸ªà¸£à¹‰à¸²à¸‡à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¹ƒà¸«à¸¡à¹ˆ: {e}", "danger")
...
def assess_session(header_id: int):
    ...
    # à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸„à¸§à¸²à¸¡à¸ªà¸¡à¸šà¸¹à¸£à¸“à¹Œà¸‚à¸­à¸‡à¹à¸•à¹ˆà¸¥à¸°à¸ªà¹ˆà¸§à¸™
    ...
    try:
        ...
        # Step 1: à¹€à¸Šà¹‡à¸„à¸§à¹ˆà¸²à¸¡à¸µà¸Šà¸·à¹ˆà¸­ à¸™à¸²à¸¡à¸ªà¸à¸¸à¸¥ à¹à¸¥à¸°à¹€à¸žà¸¨à¸„à¸£à¸šà¹„à¸«à¸¡ (à¸”à¸¶à¸‡à¸ˆà¸²à¸ patients)

        cur.execute("SELECT full_name, gender, birth_date FROM patients WHERE id = %s", (assess.get('patient_id'),))

        p = cur.fetchone()

        if p and p['full_name'] != 'à¸£à¸­à¸à¸£à¸­à¸à¸‚à¹‰à¸­à¸¡à¸¹à¸¥' and p['gender'] and p['birth_date']:

            completion['step1'] = True

            

        # Step 2: MMSE (à¹€à¸Šà¹‡à¸„à¸§à¹ˆà¸²à¸¡à¸µà¸„à¸°à¹à¸™à¸™à¸ªà¸£à¸¸à¸›à¹ƒà¸™ cga_records à¸«à¸£à¸·à¸­à¸¡à¸µà¸„à¸³à¸•à¸­à¸šà¹ƒà¸™ answers)
...
def assess_step1_save(header_id: int):
    ...
    if f.get('house_no'): readable_addr.append(f"à¹€à¸¥à¸‚à¸—à¸µà¹ˆ {f['house_no']}")

    if f.get('moo'): readable_addr.append(f"à¸«à¸¡à¸¹à¹ˆ {f['moo']}")

    if f.get('subdistrict'): readable_addr.append(f"à¸•. {f['subdistrict']}")

    if f.get('district'): readable_addr.append(f"à¸­. {f['district']}")

    if f.get('province'): readable_addr.append(f"à¸ˆ. {f['province']}")
    ...
    try:
        ...
        # ðŸŸ¢ Sync à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸”à¸¹à¹à¸¥/à¸—à¸µà¹ˆà¸­à¸¢à¸¹à¹ˆ à¸¥à¸‡ cga_records à¸—à¸±à¸™à¸—à¸µ
...
def assess_mmse(header_id: int):
    ...
    # à¹€à¸Šà¹‡à¸„à¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸¥à¹ˆà¸²à¸ªà¸¸à¸”à¹€à¸žà¸·à¹ˆà¸­à¸”à¸¹à¸§à¹ˆà¸²à¹€à¸›à¹‡à¸™à¹€à¸„à¸ªà¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸‹à¹‰à¸³à¸ à¸²à¸¢à¹ƒà¸™ 2 à¹€à¸”à¸·à¸­à¸™à¸«à¸£à¸·à¸­à¹„à¸¡à¹ˆ
    ...
    # --- [à¹€à¸žà¸´à¹ˆà¸¡à¸ªà¹ˆà¸§à¸™à¸™à¸µà¹‰] à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸„à¸§à¸²à¸¡à¸ªà¸¡à¸šà¸¹à¸£à¸“à¹Œà¸‚à¸­à¸‡à¹à¸•à¹ˆà¸¥à¸°à¸ªà¹ˆà¸§à¸™à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰à¹à¸–à¸šà¸™à¸³à¸—à¸²à¸‡à¸—à¸³à¸‡à¸²à¸™à¹„à¸”à¹‰ ---
...
def assess_mmse_save(header_id: int):
    ...
    try:
        ...
        # ðŸŸ¢ 1. à¸«à¸² cga_id à¸—à¸µà¹ˆà¹à¸—à¹‰à¸ˆà¸£à¸´à¸‡ (à¸›à¹‰à¸­à¸‡à¸à¸±à¸™ Error 1452)
        ...
        if not cur.fetchone():
            ...
            # à¸–à¹‰à¸²à¸«à¸²à¹„à¸¡à¹ˆà¹€à¸ˆà¸­ à¹à¸ªà¸”à¸‡à¸§à¹ˆà¸² header_id à¸—à¸µà¹ˆà¸ªà¹ˆà¸‡à¸¡à¸²à¸­à¸²à¸ˆà¹€à¸›à¹‡à¸™ encounter_id (à¸ˆà¸²à¸à¸«à¸™à¹‰à¸²à¸›à¸£à¸°à¸§à¸±à¸•à¸´/à¸£à¸²à¸¢à¸‡à¸²à¸™)
            ...
            if h_row:
                ...
                # à¸–à¹‰à¸²à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¹€à¸¥à¸¢ à¹ƒà¸«à¹‰à¸ªà¸£à¹‰à¸²à¸‡à¹ƒà¸«à¸¡à¹ˆà¸œà¸¹à¸à¸à¸±à¸š encounter_id à¸™à¸±à¹‰à¸™
        ...
        # (à¸ªà¹ˆà¸§à¸™à¸‚à¸­à¸‡à¸à¸²à¸£à¸§à¸™à¸¥à¸¹à¸›à¸šà¸±à¸™à¸—à¸¶à¸à¸„à¸°à¹à¸™à¸™à¹€à¸«à¸¡à¸·à¸­à¸™à¹€à¸”à¸´à¸¡ à¹à¸•à¹ˆà¹ƒà¸Šà¹‰ actual_cga_id)
...
def assess_tgds(header_id: int):
    ...
    # à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸§à¹ˆà¸²à¹€à¸›à¹‡à¸™ Baseline (à¸„à¸£à¸±à¹‰à¸‡à¹à¸£à¸) à¸«à¸£à¸·à¸­à¹„à¸¡à¹ˆ? à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸Šà¹‰à¸à¸±à¸š 8Q (à¸‚à¹‰à¸­ 8 à¸–à¸²à¸¡à¹€à¸‰à¸žà¸²à¸°à¸„à¸£à¸±à¹‰à¸‡à¹à¸£à¸)
    ...
    # à¸™à¸±à¸šà¸ˆà¸³à¸™à¸§à¸™ Header à¸à¹ˆà¸­à¸™à¸«à¸™à¹‰à¸²à¸™à¸µà¹‰à¸‚à¸­à¸‡à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¸„à¸™à¸™à¸µà¹‰
...
def assess_tgds_save(header_id: int):
    ...
    try:
        ...
        if q3_val == 'yes' and q3_sub_val == 'yes':
            ...
            q8_score += 10 # 4 (à¸ˆà¸²à¸à¸‚à¹‰à¸­ 3) + 10 (à¸ˆà¸²à¸ followup) = 14 à¸„à¸°à¹à¸™à¸™
        ...
        # ðŸŸ¢ 2. à¸„à¸³à¸™à¸§à¸“à¸„à¸§à¸²à¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡à¸£à¸§à¸¡ (Risk Level)
        ...
        current_app.logger.info(f"âœ… Local Database Committed: CGA ID {actual_cga_id}")



        # CLOUD SYNC (à¸—à¸³à¸‡à¸²à¸™à¸•à¹ˆà¸­à¸«à¸¥à¸±à¸‡à¸ˆà¸²à¸ Commit à¹à¸¥à¹‰à¸§à¹€à¸žà¸·à¹ˆà¸­à¸„à¸§à¸²à¸¡à¸£à¸§à¸”à¹€à¸£à¹‡à¸§à¸‚à¸­à¸‡à¸«à¸™à¹‰à¸²à¸ˆà¸­)
        ...
        try:
            ...
            p_latest = cur.fetchone(); sex_map = {'male': 'à¸Šà¸²à¸¢', 'female': 'à¸«à¸à¸´à¸‡'}
            ...
            current_app.logger.warning(f"âš ï¸ Cloud Sync Error (Local Data is Safe): {cloud_err}")
...
def assess_summary(header_id: int):
    ...
    # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥ HN/Encounter
    ...
    # à¸”à¸¶à¸‡à¸„à¸°à¹à¸™à¸™ 8Q (q8_score)

    q8_val = 0

    try:

        # 1. à¸¥à¸­à¸‡à¸”à¸¶à¸‡à¸ˆà¸²à¸ cga_records à¸à¹ˆà¸­à¸™
        ...
        if q8_val == 0:
            ...
            # 2. Fallback: à¸„à¸³à¸™à¸§à¸“à¸ªà¸”à¸ˆà¸²à¸ assessment_answers (à¸£à¸§à¸¡ followup à¸‚à¹‰à¸­ 3)
    ...
    # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡à¸ªà¸³à¸«à¸£à¸±à¸šà¸«à¸™à¹‰à¸² Summary (Depression 2Q, Health Behavior)
    ...
    # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸” (Full Info) à¹€à¸žà¸·à¹ˆà¸­à¹à¸ªà¸”à¸‡à¹ƒà¸™à¸«à¸™à¹‰à¸²à¸ªà¸£à¸¸à¸›à¹à¸šà¸šà¸¥à¸°à¹€à¸­à¸µà¸¢à¸”

    full_info = {}

    

    # à¹à¸›à¸¥à¸‡ key à¸ˆà¸²à¸ assessment_answers à¹ƒà¸«à¹‰à¹€à¸›à¹‡à¸™ Dictionary à¸—à¸µà¹ˆà¹€à¸‚à¹‰à¸²à¸–à¸¶à¸‡à¸‡à¹ˆà¸²à¸¢
    ...
    # à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸žà¸¨à¹€à¸‚à¹‰à¸²à¹„à¸›à¹ƒà¸™ full_info
    ...
    for r in all_ans:
        ...
        if inst == 'depression2Q':
            ...
            # à¹à¸›à¸¥à¸‡ yes/no à¹€à¸›à¹‡à¸™ à¸¡à¸µ/à¹„à¸¡à¹ˆà¸¡à¸µ

            disp_val = 'à¸¡à¸µ' if val == 'yes' else 'à¹„à¸¡à¹ˆà¸¡à¸µ'
    ...
    # à¸„à¸³à¸™à¸§à¸“ BMI à¹à¸¥à¸°à¹à¸›à¸¥à¸œà¸¥
    ...
    try:
        ...
        if w > 0 and h_cm > 0:
            ...
            if bmi < 18.5: full_info['bmi_eval'] = 'à¸œà¸­à¸¡'

            elif bmi < 23.0: full_info['bmi_eval'] = 'à¸›à¸à¸•à¸´'

            elif bmi < 25.0: full_info['bmi_eval'] = 'à¸—à¹‰à¸§à¸¡'

            else: full_info['bmi_eval'] = 'à¸­à¹‰à¸§à¸™'
    ...
    # ðŸŸ¢ [FIX] à¸›à¸£à¸°à¸à¸²à¸¨à¸•à¸±à¸§à¹à¸›à¸£à¹ƒà¸«à¹‰à¸„à¸£à¸šà¹€à¸žà¸·à¹ˆà¸­à¸›à¹‰à¸­à¸‡à¸à¸±à¸™ NameError
    ...
    # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ˆà¸²à¸ cga_records à¸¡à¸²à¹€à¸›à¹‡à¸™à¸­à¸±à¸™à¸”à¸±à¸šà¹à¸£à¸ (à¹€à¸žà¸£à¸²à¸°à¸™à¹ˆà¸²à¹€à¸Šà¸·à¹ˆà¸­à¸–à¸·à¸­à¸—à¸µà¹ˆà¸ªà¸¸à¸”)
    ...
    # à¸«à¸²à¸à¹ƒà¸™ cga_records à¸¢à¸±à¸‡à¹€à¸›à¹‡à¸™ 0 à¹ƒà¸«à¹‰à¸¥à¸­à¸‡à¸”à¸¶à¸‡à¸ˆà¸²à¸à¸•à¸²à¸£à¸²à¸‡à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¹‚à¸”à¸¢à¸•à¸£à¸‡ (header_id à¸„à¸·à¸­ ID à¸‚à¸­à¸‡ cga_headers)
    ...
    if actual_cga_id:
        ...
        # 3. à¸”à¸¶à¸‡à¸£à¸²à¸¢à¸¥à¸°à¹€à¸­à¸µà¸¢à¸”à¸£à¸²à¸¢à¸‚à¹‰à¸­ (à¸–à¹‰à¸²à¸¡à¸µ)
        ...
        # 4. à¸”à¸¶à¸‡à¸£à¸²à¸¢à¸¥à¸°à¹€à¸­à¸µà¸¢à¸”à¸£à¸²à¸¢à¸‚à¹‰à¸­ TGDS
        ...
        if tg_main:
            ...
            for r in cur.fetchall():
                ...
                tgds_details[str(r['question_no'])] = 'à¹ƒà¸Šà¹ˆ' if r['answer']==1 else 'à¹„à¸¡à¹ˆà¹ƒà¸Šà¹ˆ'
    ...
    # à¸”à¸¶à¸‡à¸„à¹ˆà¸²à¸à¸²à¸£à¸¨à¸¶à¸à¸©à¸²à¸ˆà¸²à¸ assessment_answers (instrument='basic', key='education')
    ...
    mmse_threshold = 22 # default (à¸ªà¸¹à¸‡à¸à¸§à¹ˆà¸²à¸›à¸£à¸°à¸–à¸¡ cutoff à¸—à¸µà¹ˆ 22 -> <=22 à¹€à¸ªà¸µà¹ˆà¸¢à¸‡)

    

    if edu == '1': # à¹„à¸¡à¹ˆà¹„à¸”à¹‰à¹€à¸£à¸µà¸¢à¸™/à¸­à¹ˆà¸²à¸™à¹€à¸‚à¸µà¸¢à¸™à¹„à¸¡à¹ˆà¹„à¸”à¹‰

        mmse_total = 23

        mmse_threshold = 14

    elif edu == '2': # à¸›à¸£à¸°à¸–à¸¡
    ...
    # logic: Score <= Threshold à¸„à¸·à¸­ "à¹€à¸ªà¸µà¹ˆà¸¢à¸‡" (Suspected)

    mmse_risk_status = 'suspected' if m_score <= mmse_threshold else 'normal'

    

    # ðŸŸ¢ AI HMM Prediction

    ai_result = {"label": "à¸£à¸­à¸à¸²à¸£à¸›à¸£à¸°à¸¡à¸§à¸¥à¸œà¸¥", "risk_score": 0, "factors": []}
    ...
    real_cga_id = header_id # à¸à¸³à¸«à¸™à¸” ID à¹ƒà¸«à¹‰à¸–à¸¹à¸à¸•à¹‰à¸­à¸‡à¹€à¸žà¸·à¹ˆà¸­à¸›à¹‰à¸­à¸‡à¸à¸±à¸™ NameError



    try:

        # 1. à¸”à¸¶à¸‡à¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸„à¸°à¹à¸™à¸™ MMSE à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸”à¸‚à¸­à¸‡à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¸„à¸™à¸™à¸µà¹‰à¸ˆà¸²à¸ Local MySQL
        ...
        # à¸£à¸§à¸¡à¸„à¸°à¹à¸™à¸™à¸„à¸£à¸±à¹‰à¸‡à¸›à¸±à¸ˆà¸ˆà¸¸à¸šà¸±à¸™à¹€à¸‚à¹‰à¸²à¹„à¸›à¸—à¹‰à¸²à¸¢à¸ªà¸¸à¸”à¸‚à¸­à¸‡à¸›à¸£à¸°à¸§à¸±à¸•à¸´

        mmse_history.append(m_score)



        # 2. à¹€à¸•à¸£à¸µà¸¢à¸¡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ªà¸³à¸«à¸£à¸±à¸š AI
        ...
        # 3. à¹ƒà¸«à¹‰ Predictor à¸›à¸£à¸°à¸¡à¸§à¸¥à¸œà¸¥
        ...
        # 4. à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸›à¸±à¸ˆà¸ˆà¸±à¸¢à¹€à¸ªà¸µà¹ˆà¸¢à¸‡ (Factors) à¹€à¸ªà¸¡à¸­ (à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰ UI à¹à¸ªà¸”à¸‡à¸œà¸¥à¹„à¸”à¹‰à¸ªà¸¡à¸šà¸¹à¸£à¸“à¹Œ)

        factors = []

        if m_score <= mmse_threshold: factors.append("à¸ªà¸¡à¸£à¸£à¸–à¸ à¸²à¸žà¸ªà¸¡à¸­à¸‡à¸•à¹ˆà¸³à¸à¸§à¹ˆà¸²à¹€à¸à¸“à¸‘à¹Œ")

        if t_score >= 7: factors.append("à¸žà¸šà¸ à¸²à¸§à¸°à¸‹à¸¶à¸¡à¹€à¸¨à¸£à¹‰à¸²")

        if inc_val == 'abnormal': factors.append("à¸¡à¸µà¸›à¸±à¸à¸«à¸²à¸à¸²à¸£à¸à¸¥à¸±à¹‰à¸™à¸›à¸±à¸ªà¸ªà¸²à¸§à¸°")

        if sl_val == 'abnormal': factors.append("à¸¡à¸µà¸›à¸±à¸à¸«à¸²à¸à¸²à¸£à¸™à¸­à¸™à¸«à¸¥à¸±à¸š")

        if sr_val == 'yes': factors.append("à¸¡à¸µà¸„à¸§à¸²à¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡à¸†à¹ˆà¸²à¸•à¸±à¸§à¸•à¸²à¸¢")

        

        if full_info.get('hearing_left') == 'abnormal' or full_info.get('hearing_right') == 'abnormal':

            factors.append("à¸žà¸šà¸„à¸§à¸²à¸¡à¸œà¸´à¸”à¸›à¸à¸•à¸´à¸‚à¸­à¸‡à¸à¸²à¸£à¹„à¸”à¹‰à¸¢à¸´à¸™")

        if chronic_count >= 3:

            factors.append("à¸¡à¸µà¹‚à¸£à¸„à¸›à¸£à¸°à¸ˆà¸³à¸•à¸±à¸§à¸«à¸¥à¸²à¸¢à¹‚à¸£à¸„")
        ...
        ai_result = {"error": str(e), "label": "à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¸§à¸´à¹€à¸„à¸£à¸²à¸°à¸«à¹Œà¹„à¸”à¹‰", "risk_score": 0, "factors": []}



    # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥ HN à¹à¸¥à¸° GCN à¸¥à¹ˆà¸²à¸ªà¸¸à¸”
    ...
    return render_template('nurse/summary.html', header_id=header_id, hn=fresh_p['hn'], gcn=fresh_p['gcn'], patient=data, date=date.today().strftime('%d/%m/%Y'), mmse_score=m_score, mmse_total=mmse_total, mmse_risk=mmse_risk_status, mmse_threshold=mmse_threshold, tgds_score=t_score, tgds_risk=('normal' if t_score < 7 else 'suspected'), tgds_risk_label=('à¸›à¸à¸•à¸´' if t_score < 7 else 'à¸¡à¸µà¸ à¸²à¸§à¸°à¸‹à¸¶à¸¡à¹€à¸¨à¸£à¹‰à¸²'), suicide_risk=sr_val, incontinence=inc_val, sleep=sl_val, status=h_status, dep_2q=dep_2q_display, mmse_details=mmse_details, tgds_details=tgds_details, q8_score=q8_val, full_info=full_info, ai_result=ai_result)
...
def _sync_to_cga_records(header_id, conn, cur):
    ...
    try:
        ...
        # 1. à¸„à¹‰à¸™à¸«à¸²à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸žà¸·à¹‰à¸™à¸à¸²à¸™
        ...
        if not base_info:
            ...
            print(f"âš ï¸ [SYNC FAIL] Could not find base_info for ID {header_id}")

            return



        # ðŸŸ¢ à¸šà¸±à¸‡à¸„à¸±à¸šà¸„à¹ˆà¸² NOT NULL à¹ƒà¸«à¹‰à¸¡à¸µà¸„à¹ˆà¸²à¹€à¸ªà¸¡à¸­
        ...
        if actual_encounter_id == 0 or actual_patient_id == 0:
            ...
            print(f"âš ï¸ [SYNC FAIL] Missing IDs: Enc={actual_encounter_id}, Pat={actual_patient_id}")
        ...
        if actual_header_id:
            ...
            # à¸„à¸³à¸™à¸§à¸“à¸„à¸°à¹à¸™à¸™ 8Q à¸ˆà¸²à¸ answers
        ...
        # 4. à¸ˆà¸±à¸”à¸à¸²à¸£à¸§à¸±à¸™à¸—à¸µà¹ˆà¹ƒà¸«à¹‰à¹€à¸›à¹‡à¸™à¸¡à¸²à¸•à¸£à¸à¸²à¸™
        ...
        # 5. à¹€à¸•à¸£à¸µà¸¢à¸¡ Payload

        # à¸„à¸³à¸™à¸§à¸“à¸„à¸§à¸²à¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡ MMSE à¸•à¸²à¸¡à¸£à¸°à¸”à¸±à¸šà¸à¸²à¸£à¸¨à¸¶à¸à¸©à¸²à¸ˆà¸£à¸´à¸‡
        ...
        record_data = {
            ...
            "full_name": base_info['full_name'] or "à¸£à¸­à¸à¸£à¸­à¸à¸‚à¹‰à¸­à¸¡à¸¹à¸¥",

            "assessed_date": assessed_dt_str,

            "age": base_info['age_year'] or 0,

            "education": {'1':'à¹„à¸¡à¹ˆà¹„à¸”à¹‰à¹€à¸£à¸µà¸¢à¸™','2':'à¸›à¸£à¸°à¸–à¸¡','3':'à¸ªà¸¹à¸‡à¸à¸§à¹ˆà¸²à¸›à¸£à¸°à¸–à¸¡'}.get(data_map['education'], 'à¸ªà¸¹à¸‡à¸à¸§à¹ˆà¸²à¸›à¸£à¸°à¸–à¸¡'),

            "caregiver_name": data_map['caregiver_name'] or "",

            "mmse_score": mmse_score,

            "mmse_result": 'à¹€à¸ªà¸µà¹ˆà¸¢à¸‡' if mmse_score <= record_mmse_cutoff else 'à¸›à¸à¸•à¸´',

            "tgds_score": tgds_score,

            "tgds_result": 'à¸‹à¸¶à¸¡à¹€à¸¨à¸£à¹‰à¸²' if tgds_score >= 7 else 'à¸›à¸à¸•à¸´',

            "q8_score": q8_score, # à¹€à¸žà¸´à¹ˆà¸¡à¸Ÿà¸´à¸¥à¸”à¹Œà¸„à¸°à¹à¸™à¸™ 8Q à¹ƒà¸«à¹‰à¸ªà¸¡à¸šà¸¹à¸£à¸“à¹Œ

            "suicide_risk": 'à¸¡à¸µ' if data_map['suicide_risk'] == 'yes' else 'à¹„à¸¡à¹ˆà¸¡à¸µ',

            "incontinence": data_map['incontinence_detail'] if data_map['incontinence']=='abnormal' else 'à¸›à¸à¸•à¸´',

            "sleep_problem": data_map['sleep_problem_detail'] if data_map['sleep_problem']=='abnormal' else 'à¸›à¸à¸•à¸´',

            "smoke": {'no':'à¹„à¸¡à¹ˆà¸ªà¸¹à¸š','quit':'à¹€à¸¥à¸´à¸à¹à¸¥à¹‰à¸§','yes':'à¸ªà¸¹à¸š'}.get(data_map['smoke'], 'à¹„à¸¡à¹ˆà¸£à¸°à¸šà¸¸'),

            "alcohol": {'none':'à¹„à¸¡à¹ˆà¸”à¸·à¹ˆà¸¡','no':'à¹„à¸¡à¹ˆà¸”à¸·à¹ˆà¸¡','social':'à¸”à¸·à¹ˆà¸¡à¸šà¸²à¸‡à¸„à¸£à¸±à¹‰à¸‡','daily':'à¸”à¸·à¹ˆà¸¡à¸—à¸¸à¸à¸§à¸±à¸™'}.get(data_map['alcohol'], 'à¹„à¸¡à¹ˆà¸£à¸°à¸šà¸¸')

        }



        # 6. Local Update (à¹ƒà¸Šà¹‰à¸§à¸´à¸˜à¸µ DELETE à¹à¸¥à¹‰à¸§ INSERT à¹€à¸žà¸·à¹ˆà¸­à¸„à¸§à¸²à¸¡à¹à¸™à¹ˆà¸™à¸­à¸™ 100% à¸šà¸™à¸—à¸¸à¸ Engine)
        ...
        try:
            ...
            print(f"âœ… [LOCAL SYNC OK] HN: {record_data['hn']}")

        except Exception as local_e:

            print(f"âŒ [LOCAL SYNC ERR] {local_e}")
        ...
        try:
            ...
            if sb_p_res.data:
                ...
                print(f"â˜ï¸ [CLOUD SYNC OK] HN: {record_data['hn']}")

        except Exception as cloud_e: 

            print(f"â˜ï¸ [CLOUD SYNC ERR] {cloud_e}")

            

    except Exception as e:

        print(f"ðŸ”¥ [CRITICAL SYNC ERR] {e}")
...
def send_to_doctor(header_id: int):
    ...
    try:
        ...
        # ðŸŸ¢ à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥ Suicide Risk à¹€à¸žà¸·à¹ˆà¸­à¸„à¸³à¸™à¸§à¸“à¸„à¸§à¸²à¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡à¹ƒà¸«à¸¡à¹ˆ
        ...
        if not final_hn or str(final_hn).startswith("TMP"):
            ...
            # à¸­à¸±à¸›à¹€à¸”à¸• HN à¸ˆà¸£à¸´à¸‡à¸à¸¥à¸±à¸šà¹€à¸‚à¹‰à¸²à¹„à¸›à¹ƒà¸™ cga_records à¸”à¹‰à¸§à¸¢ (à¸–à¹‰à¸²à¸¡à¸µà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸­à¸¢à¸¹à¹ˆà¹à¸¥à¹‰à¸§)
        ...
        sex_map = {'male': 'à¸Šà¸²à¸¢', 'female': 'à¸«à¸à¸´à¸‡'}



        # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸”à¸¹à¹à¸¥à¸ˆà¸²à¸ Local Answers
        ...
        sb_p = {
            ...
            **caregiver_info # à¸£à¸§à¸¡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸”à¸¹à¹à¸¥
        ...
        # 1. à¹ƒà¸Šà¹‰ Safe Sync à¸ªà¸³à¸«à¸£à¸±à¸šà¸—à¸°à¹€à¸šà¸µà¸¢à¸™à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢

        ok, msg = safe_supabase_sync("patients", sb_p, method='upsert', conflict_col='hn')

        if not ok: sync_errors.append(f"à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢: {msg}")

        

        # 2. à¸ªà¹ˆà¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸à¸²à¸£à¸¡à¸²à¸•à¸£à¸§à¸ˆ (Encounters) - à¸ˆà¸³à¹€à¸›à¹‡à¸™à¸¡à¸²à¸à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰ Headers à¸¡à¸µà¸—à¸µà¹ˆà¹€à¸à¸²à¸°
        ...
        if enc_raw:
            ...
            if sb_p_res.data:
                ...
                if not ok: sync_errors.append(f"à¸à¸²à¸£à¸¡à¸²à¸•à¸£à¸§à¸ˆ: {msg}")



        # à¸„à¸³à¸™à¸§à¸“à¸„à¸§à¸²à¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡ MMSE à¸•à¸²à¸¡à¸£à¸°à¸”à¸±à¸šà¸à¸²à¸£à¸¨à¸¶à¸à¸©à¸²

        # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸£à¸°à¸”à¸±à¸šà¸à¸²à¸£à¸¨à¸¶à¸à¸©à¸²à¸ˆà¸²à¸ basic info
        ...
        # à¸ªà¸¡à¸¡à¸•à¸´à¸§à¹ˆà¸² question_no=3 à¸„à¸·à¸­ education (à¸•à¹‰à¸­à¸‡à¹€à¸Šà¹‡à¸„à¸ˆà¸²à¸ form à¸­à¸µà¸à¸—à¸µ à¹à¸•à¹ˆà¹€à¸šà¸·à¹‰à¸­à¸‡à¸•à¹‰à¸™à¹ƒà¸Šà¹‰à¸à¸²à¸£à¸”à¸¶à¸‡à¸ˆà¸²à¸ answer_text à¸—à¸µà¹ˆà¹€à¸à¹‡à¸š key:value à¸”à¸µà¸à¸§à¹ˆà¸²)
        ...
        edu_level = '3' # Default à¸ªà¸¹à¸‡à¸à¸§à¹ˆà¸²à¸›à¸£à¸°à¸–à¸¡
        ...
        if edu_level == '1': # à¹„à¸¡à¹ˆà¹„à¸”à¹‰à¹€à¸£à¸µà¸¢à¸™/à¸­à¹ˆà¸²à¸™à¹€à¸‚à¸µà¸¢à¸™à¹„à¸¡à¹ˆà¹„à¸”à¹‰

            mmse_cutoff = 14

        elif edu_level == '2': # à¸›à¸£à¸°à¸–à¸¡à¸¨à¸¶à¸à¸©à¸²
        ...
        # à¹€à¸•à¸£à¸µà¸¢à¸¡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡à¸ªà¸³à¸«à¸£à¸±à¸š Consultation

        extra_consult = {

            "age": p_raw.get('age_year'),

            "cognition_status": "à¹€à¸ªà¸µà¹ˆà¸¢à¸‡à¸ à¸²à¸§à¸°à¸ªà¸¡à¸­à¸‡à¹€à¸ªà¸·à¹ˆà¸­à¸¡" if is_mmse_risk else "à¸›à¸à¸•à¸´",
        ...
        # à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ˆà¸²à¸à¸„à¸³à¸•à¸­à¸š (answers)
        ...
        # 3. à¸ªà¹ˆà¸‡à¹ƒà¸šà¸ªà¹ˆà¸‡à¸•à¸±à¸§à¸«à¸²à¸«à¸¡à¸­

        ok, msg = safe_supabase_sync("consultations", consult_data, method='insert')

        if not ok: sync_errors.append(f"à¹ƒà¸šà¸ªà¹ˆà¸‡à¸•à¸±à¸§: {msg}")

        

        # 4. à¸­à¸±à¸›à¹€à¸”à¸•à¸ªà¸–à¸²à¸™à¸°à¹à¸¥à¸°à¸£à¸°à¸”à¸±à¸šà¸„à¸§à¸²à¸¡à¹€à¸ªà¸µà¹ˆà¸¢à¸‡à¹ƒà¸™ Cloud CGA Header à¸”à¹‰à¸§à¸¢
        ...
        if not ok: sync_errors.append(f"à¸ªà¸£à¸¸à¸› CGA: {msg}")
        ...
        if sync_errors:
            ...
            flash(f"à¸ªà¹ˆà¸‡à¸•à¹ˆà¸­à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ªà¸³à¹€à¸£à¹‡à¸ˆ à¹à¸•à¹ˆà¸¡à¸µà¸›à¸±à¸à¸«à¸²à¸à¸²à¸£ Sync à¸šà¸²à¸‡à¸ªà¹ˆà¸§à¸™: {'; '.join(sync_errors)}", "warning")

        else:

            flash(f"à¸ªà¹ˆà¸‡à¸•à¹ˆà¸­à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸„à¸™à¹„à¸‚à¹‰ {final_hn} à¹ƒà¸«à¹‰à¹à¸žà¸—à¸¢à¹Œà¹€à¸£à¸µà¸¢à¸šà¸£à¹‰à¸­à¸¢à¹à¸¥à¹‰à¸§", "success")
...
def assess_finalize(header_id: int):
    ...
    try:
        ...
        # 1. à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸—à¸µà¹ˆà¸ˆà¸³à¹€à¸›à¹‡à¸™à¸¡à¸²à¹€à¸•à¸£à¸µà¸¢à¸¡à¹„à¸§à¹‰
        ...
        if not h_data:
             ...
             flash("à¹„à¸¡à¹ˆà¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™", "danger")
        ...
        # à¹€à¸•à¸£à¸µà¸¢à¸¡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ªà¸³à¸«à¸£à¸±à¸š Sync
        ...
        # 3. Sync Encounters (à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰ Header à¸¡à¸µà¸—à¸µà¹ˆà¹€à¸à¸²à¸°)
        ...
        if enc_raw:
             ...
             # à¸•à¹‰à¸­à¸‡à¸«à¸² ID à¸‚à¸­à¸‡ patient à¹ƒà¸™ Supabase à¸à¹ˆà¸­à¸™ (à¸–à¹‰à¸²à¹ƒà¸Šà¹‰ ID à¹€à¸›à¹‡à¸™ FK) à¸«à¸£à¸·à¸­à¸ªà¹ˆà¸‡à¹€à¸›à¹‡à¸™ HN à¸–à¹‰à¸² Cloud à¸£à¸­à¸‡à¸£à¸±à¸š

             # à¹ƒà¸™à¸—à¸µà¹ˆà¸™à¸µà¹‰à¸ªà¸¡à¸¡à¸•à¸´à¸§à¹ˆà¸² Cloud à¹ƒà¸Šà¹‰ ID à¹€à¸›à¹‡à¸™ FK à¹€à¸«à¸¡à¸·à¸­à¸™ Local
             ...
             try:
                ...
                sync_errors.append(f"à¹€à¸Šà¸·à¹ˆà¸­à¸¡à¹‚à¸¢à¸‡à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢: {str(e)}")



        # 4. Sync CGA Headers (Update Status)

        # à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸š Risk Level à¸¥à¹ˆà¸²à¸ªà¸¸à¸”à¸à¹ˆà¸­à¸™à¸ªà¹ˆà¸‡
        ...
        if sync_errors:
            ...
            flash(f"à¸šà¸±à¸™à¸—à¸¶à¸à¹€à¸ªà¸£à¹‡à¸ˆà¸ªà¸´à¹‰à¸™ à¹à¸•à¹ˆ Sync à¸šà¸²à¸‡à¸£à¸²à¸¢à¸à¸²à¸£à¹„à¸¡à¹ˆà¸ªà¸³à¹€à¸£à¹‡à¸ˆ: {'; '.join(sync_errors)}", "warning")

        else:

            flash("à¸šà¸±à¸™à¸—à¸¶à¸à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¹à¸¥à¸° Sync à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ªà¸³à¹€à¸£à¹‡à¸ˆ", "success")
        ...
        flash(f"à¹€à¸à¸´à¸”à¸‚à¹‰à¸­à¸œà¸´à¸”à¸žà¸¥à¸²à¸”: {e}", "danger")
...
def patients():
    ...
    # ðŸŸ¢ à¸›à¸£à¸±à¸šà¸›à¸£à¸¸à¸‡: à¸”à¸¶à¸‡à¸ˆà¸²à¸ Local MySQL à¹€à¸›à¹‡à¸™à¸«à¸¥à¸±à¸à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸«à¹‰à¹€à¸«à¹‡à¸™à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸¥à¹ˆà¸²à¸ªà¸¸à¸”à¸—à¸µà¹ˆà¹à¸à¹‰à¹„à¸‚à¹ƒà¸™à¹€à¸„à¸£à¸·à¹ˆà¸­à¸‡
...
def patient_history(hn: str):
    ...
    try:
        ...
        if not patient:
            ...
            flash("à¹„à¸¡à¹ˆà¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¹ƒà¸™à¸£à¸°à¸šà¸š Local", "danger")

            return redirect(url_for("nurse.patients"))

        

        # ðŸŸ¢ Format HN à¹ƒà¸«à¹‰à¸•à¸£à¸‡à¸à¸±à¸šà¸«à¸™à¹‰à¸²à¸£à¸²à¸¢à¸Šà¸·à¹ˆà¸­à¸«à¸¥à¸±à¸
        ...
        # ðŸŸ¢ à¸”à¸¶à¸‡à¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸ˆà¸²à¸ cga_records
...
def patient_edit(hn: str):
    ...
    try:
        ...
        if not patient:
            ...
            flash("à¹„à¸¡à¹ˆà¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢", "danger")
...
def patient_update(hn: str):
    ...
    try:
        ...
        # 1. à¸«à¸²à¸‚à¹‰à¸­à¸¡à¸¹à¸¥ ID à¹€à¸”à¸´à¸¡à¸à¹ˆà¸­à¸™à¸­à¸±à¸›à¹€à¸”à¸•
        ...
        # 2. à¸—à¸³à¸à¸²à¸£à¸­à¸±à¸›à¹€à¸”à¸•à¸•à¸²à¸£à¸²à¸‡ patients
        ...
        # 3. ðŸŸ¢ à¸šà¸±à¸‡à¸„à¸±à¸š Sync à¸¥à¸‡ cga_records à¸ªà¸³à¸«à¸£à¸±à¸š Encounter à¸¥à¹ˆà¸²à¸ªà¸¸à¸”

        # à¸«à¸² Encounter à¸¥à¹ˆà¸²à¸ªà¸¸à¸”à¸‚à¸­à¸‡à¸„à¸™à¹„à¸‚à¹‰à¸„à¸™à¸™à¸µà¹‰ (à¹ƒà¸Šà¹‰ p_id à¸ˆà¸°à¹à¸¡à¹ˆà¸™à¸¢à¸³à¸à¸§à¹ˆà¸² hn à¹€à¸žà¸£à¸²à¸° hn à¸žà¸¶à¹ˆà¸‡à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¹„à¸”à¹‰)
        ...
        if latest_e:
            ...
            # à¸žà¸¢à¸²à¸¢à¸²à¸¡à¸«à¸² Header à¸—à¸µà¹ˆà¸œà¸¹à¸à¸à¸±à¸š Encounter à¸™à¸µà¹‰
            ...
            # à¸£à¸±à¸™ Sync à¹‚à¸”à¸¢à¸ªà¹ˆà¸‡ header_id (à¸–à¹‰à¸²à¸¡à¸µ) à¸«à¸£à¸·à¸­ encounter_id à¹„à¸›
        ...
        try:
            ...
            supabase_sex = 'à¸Šà¸²à¸¢' if f.get('gender') == 'male' else ('à¸«à¸à¸´à¸‡' if f.get('gender') == 'female' else None)
            ...
            # à¹ƒà¸Šà¹‰ Safe Sync à¹€à¸žà¸·à¹ˆà¸­à¸›à¹‰à¸­à¸‡à¸à¸±à¸™ Error à¸ˆà¸²à¸à¸„à¸­à¸¥à¸±à¸¡à¸™à¹Œà¸—à¸µà¹ˆà¹„à¸¡à¹ˆà¸¡à¸µ
        ...
        flash("à¸šà¸±à¸™à¸—à¸¶à¸à¸à¸²à¸£à¹à¸à¹‰à¹„à¸‚à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹€à¸£à¸µà¸¢à¸šà¸£à¹‰à¸­à¸¢à¹à¸¥à¹‰à¸§", "success")
...
def patient_delete(hn: str):
    ...
    try:
        ...
        if not patient:
            ...
            flash("à¹„à¸¡à¹ˆà¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢", "warning")
        ...
        # 2. à¸¥à¹‰à¸²à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹ƒà¸™à¸•à¸²à¸£à¸²à¸‡à¸—à¸µà¹ˆà¹€à¸à¸µà¹ˆà¸¢à¸§à¸‚à¹‰à¸­à¸‡ (Cascaded Cleanup)

        # à¸«à¸² encounters à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸”à¸‚à¸­à¸‡à¸„à¸™à¹„à¸‚à¹‰à¸„à¸™à¸™à¸µà¹‰
        ...
        # 3. à¸¥à¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢ (Local)
        ...
        # 4. à¸¥à¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹ƒà¸™ Cloud (Supabase)

        try:

            supabase = get_supabase_client()

            # à¸¥à¸š cga_records à¸šà¸™ cloud à¸à¹ˆà¸­à¸™

            supabase.table("cga_records").delete().eq("hn", hn).execute()

            # à¸¥à¸šà¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¸šà¸™ cloud
        ...
        flash("à¸¥à¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸œà¸¹à¹‰à¸›à¹ˆà¸§à¸¢à¹à¸¥à¸°à¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸”à¹€à¸£à¸µà¸¢à¸šà¸£à¹‰à¸­à¸¢à¹à¸¥à¹‰à¸§", "success")

    except Exception as e:

        conn.rollback()

        flash(f"à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¸¥à¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹„à¸”à¹‰: {e}", "danger")
